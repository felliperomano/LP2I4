...
public class Form2 implements ActionListener {
	...
	private JTextField t2 = new JTextField(12);
        ...
        String[] sexos = { "M", "F"};
	private JComboBox t3 = new JComboBox(sexos);
	...
	private JPanel p1 = new JPanel();
        ...
        public void actionPerformed(ActionEvent e){
            ...
            if("OK".equals(command)){
                ...
                String teste3 = String.valueOf(t3.getSelectedItem());             
                String teste4 = t4.getText();
                    if(!teste2.equals("") && !teste4.equals("")){                 
                        umaPessoa = new Pessoa(t2.getText(), teste3.charAt(0),Integer.parseInt(t4.getText()));
                        t1.setText("");
                        t2.setText("");
                        t4.setText("");                    
                    }
            ...
            if("Mostrar".equals(command)){
                ...
                t3.setSelectedItem(String.valueOf(umaPessoa.getSexo()));
